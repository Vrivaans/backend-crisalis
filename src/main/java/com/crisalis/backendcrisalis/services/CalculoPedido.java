...
public class CalculoPedido {
    ...
    // public OrderE calcularPedidoGuardar(OrderE order){
    ...
    //         //BORRAR
    //         // if(listaServiciosContratadosActivos.size() >= 1){
    //         // ServiciosContratados servicioContratadoActivo = new ServiciosContratados();
    //         // servicioContratadoActivo = listaServiciosContratadosActivos.get(1);
    //         // float monto = 0;
    //         // monto = servicioContratadoActivo.getMonto() + descuentoServicioActivo;
    //         // servicioContratadoActivo.setMonto(monto);
    //         // }
